...
//BoxCollider_ver2::BoxCollider_ver2(const COMPONENT_INIT_DESC & desc)
//{
//	type = MyCustom::COLLIDER_BOX_VER2;
...
void BoxCollider_ver2::initialize(const COMPONENT_INIT_DESC & desc)
{
	type = MyCustom::COLLIDER_BOX_VER2;
	gameObject = desc.mGameObj;
	transform = desc.mTransform;
...
void SphereCollider_ver2::initialize(const COMPONENT_INIT_DESC & desc)
{
	type = MyCustom::COLLIDER_BOX_VER2;
	gameObject = desc.mGameObj;
	transform = desc.mTransform;
...
void BoxRigidBody::initialize(const COMPONENT_INIT_DESC & desc)
{
	type = MyCustom::COLLIDER_BOX_VER2;
	gameObject = desc.mGameObj;
	transform = desc.mTransform;
...
void SphereRigidBody::initialize(const COMPONENT_INIT_DESC & desc)
{
	type = MyCustom::COLLIDER_SPHERE_VER2;
	gameObject = desc.mGameObj;
	transform = desc.mTransform;
	Time = desc.mTime;
}
...
void CharacterController::initialize(const COMPONENT_INIT_DESC & desc)
{
	type = MyCustom::COLLIDER_BOX_VER2;
	gameObject = desc.mGameObj;
	transform = desc.mTransform;
