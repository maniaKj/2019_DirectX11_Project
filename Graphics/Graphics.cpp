...
void Graphics::RenderColliderDebug(std::vector<Collider*>* physicsCompoBuffer)
{
	...
	for (std::vector<Collider*>::iterator it = physicsCompoBuffer->begin(); it != physicsCompoBuffer->end(); it++) {
...
{
	for (std::vector<Terrain*>::iterator it = terrainBuffer->begin(); it != terrainBuffer->end(); it++) {
