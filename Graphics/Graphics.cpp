...
void Graphics::RenderColliderDebug(std::vector<std::shared_ptr<Collider>> * physicsCompoBuffer)
{
...
bool Graphics::SetConstantBuffer()
{
...
void Graphics::InitializeSimpleGeometry(ModelBuffer & _modelBuffer)
{
...
bool Graphics::InitializeTerrain(TerrainModelBuffer & _terrainmodelBuffer)
{
...
bool Graphics::InitializeDebugDraw()
{
