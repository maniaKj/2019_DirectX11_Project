...
DirectX::XMFLOAT3 quatToEuler3(float x, float y, float z, float w)
{
	...
	return DirectX::XMFLOAT3(roll / DirectX::XM_PI * 180, pitch / DirectX::XM_PI * 180, yaw / DirectX::XM_PI * 180);
}
...
#pragma region RENDER_ImGUI
	...
	DirectX::XMFLOAT3 finalEuler = quatToEuler3(midQuaternion.x, midQuaternion.y, midQuaternion.z, midQuaternion.w);
